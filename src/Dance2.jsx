...
Command: npx gltfjsx@6.1.4 dance2.glb
*/

import React, { useEffect, useRef } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

export default function Dance2(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/model/all.glb')
  const { actions } = useAnimations(animations, group)
  useEffect(()=>{
    console.log("Da chay",actions)
    ...
    //actions.Dance.play();
    //  actions.stand.play();
    console.log("Da set page About va nhay")
  }
  if(props.page==="works"){ 
    //actions.Dance.play();
    //  actions.stand.play();
    console.log("Da set page Works va lam viec");
    actions.stay.stop();
    actions.phone.stop();
    actions.type.play();
  }
  if(props.page==="contact"){ 
    //actions.Dance.play();
    //  actions.stand.play();
    console.log("Da set page Contact va goi dien")
    actions.stay.stop();
    actions.type.stop();
    actions.phone.play();
  }
